...
import io.github.hugoangeles0810.comiccharacters.data.source.local.MarvelCharactersPersistentContract.CharacterEntry;


public class CharactersLocalDataSourceImpl
    implements io.github.hugoangeles0810.comiccharacters.data.source.CharactersLocalDataSource {
    ...
    public void getCharacters(String term, int offset, int limit, @NonNull LoadCharactersCallback callback) {
        ...
        String selectionQuery = CharacterEntry.COLUMN_NAME_NAME + " LIKE ?";
