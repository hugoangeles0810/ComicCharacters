...
public class CharactersRepositoryImpl implements CharactersRepository {
    ...
    @Override
    public void getCharacters(final String term, final int offset,
                              final int limit, @NonNull final LoadCharactersCallback callback) {
        mCharsRemoteDataSource.getCharacters(term, offset, limit,
                new CharactersRemoteDataSource.LoadCharactersCallback() {
            @Override public void onCharactersLoaded(List<Character> characters) {
                callback.onCharactersLoaded(characters);
                mCharsLocalDataSource.saveOrUpdate(characters);
            }
            ...
            @Override public void onDataNotAvailable() {
                getCharactersFromLocalDataSource(term, offset, limit, callback);
            }
        });
    }
    ...
    private void getCharactersFromLocalDataSource(String term, int offset,
                                                  int limit, final LoadCharactersCallback callback) {
        mCharsLocalDataSource.getCharacters(term, offset, limit,
                new CharactersLocalDataSource.LoadCharactersCallback() {
            @Override
            public void onCharactersLoaded(List<Character> characters) {
                callback.onCharactersLoaded(characters);
            }
